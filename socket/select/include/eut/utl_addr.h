...
int utl_addr_get_route(const char* dest, const char* mask, char ifname[32], char gw[32]);
int utl_addr_get_ifbytes(const char* ifname, long long* rx_bytes, long long* tx_bytes);
