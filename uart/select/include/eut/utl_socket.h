...
typedef int (*utl_sock_hook_chkport_f)(utl_sock_proto_e ptype, utl_addr_t* laddr);

void utl_sock_set_hook_chkport(utl_sock_hook_chkport_f fpChkPort);
...
utl_sock utl_sock_open(utl_addr_type_e atype, const char* host, int port, bool reuse);
utl_sock utl_sock_open_udp(const char* host, int port);
utl_sock utl_sock_open_tcp(const char* host, int port, bool reuse);
utl_sock utl_sock_open_unix(const char* path, bool reuse);
...
int utl_sock_connect_errno(utl_sock s);
