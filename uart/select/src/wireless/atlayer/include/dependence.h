...
_SHORT16    Utl_StrLen(const _CHAR8* strMain);
...
/**memory operation*/
_BOOL  Utl_MemSet(_VOID* strDest, _UCHAR8 chr, _USHORT16 count);
...
_SHORT16 AK_vatcWrite(_SHORT16 ChanId, T_pCDATA data, _SHORT16 count);
