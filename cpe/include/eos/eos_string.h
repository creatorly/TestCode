...
#undef EOS_MEMCMP_DEBUG
#define EOS_MEMMOVE_DEBUG

#undef EOS_STRLEN_DEBUG
#define EOS_STRCPY_DEBUG
#undef EOS_STRNCPY_DEBUG
#define EOS_STRCAT_DEBUG
#undef EOS_STRNCAT_DEBUG
#undef EOS_STRCMP_DEBUG
#undef EOS_STRNCMP_DEBUG
#undef EOS_STRCASECMP_DEBUG
#undef EOS_STRNCASECMP_DEBUG
#undef EOS_STRCHR_DEBUG
#undef EOS_STRRCHR_DEBUG
#undef EOS_STRSTR_DEBUG

#undef EOS_PRINTF_DEBUG
#define EOS_FPRINTF_DEBUG
#define EOS_SPRINTF_DEBUG
#undef EOS_SNPRINTF_DEBUG

#undef EOS_VPRINTF_DEBUG
#define EOS_VFPRINTF_DEBUG
#define EOS_VSPRINTF_DEBUG
#undef EOS_VSNPRINTF_DEBUG

#undef EOS_SCANF_DEBUG
#undef EOS_FSCANF_DEBUG
#undef EOS_SSCANF_DEBUG
